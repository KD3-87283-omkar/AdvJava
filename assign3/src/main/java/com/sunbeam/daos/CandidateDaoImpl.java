...
public class CandidateDaoImpl extends Dao implements CandidateDao {
	...
	private PreparedStatement stmtAddVote;
	...
	public CandidateDaoImpl() throws Exception {
		...
		String sqlAddVote="update candidates set votes=votes+1 where id=?";
		stmtAddVote=con.prepareStatement(sqlAddVote);
	}
	...
	@Override
	public int incrementVote(int id) throws Exception {
		 stmtAddVote.setInt(1, id);
		   int cnt=stmtAddVote.executeUpdate();
		return cnt;
	}
}
